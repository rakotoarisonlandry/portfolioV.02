...
const services = [
  ...
  },
  {
    ...
    features: ["Speed Optimization", "SEO Improvement", "Code Refactoring", "Performance Monitoring"],
    price: "Starting at €1,000",
  },
  {
    icon: Users,
    title: "Consulting & Strategy",
    description: "Technical consulting and strategic planning for your digital transformation projects.",
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="space-y-6">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              I offer a comprehensive range of digital services to help bring your ideas to life and grow your business
              online.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Bringing your vision to life with clean code and beautiful design.",
              },
              {
                step: "04",
