      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">Creative Developer crafting exceptional digital experiences.</p>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400 text-sm">© 2024 LANDRY. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
