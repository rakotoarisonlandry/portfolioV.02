            ...
            <div className="space-y-6">
              ...
              <div className="animate-on-scroll opacity-0" style={{ animationDelay: "0.4s" }}>
                <p className="text-lg text-gray-600 max-w-lg leading-relaxed">
                  A Creative UI/UX Designer and Developer based in France. I strive to build immersive and beautiful web
                  applications through carefully crafted user-friendly design.
                </p>
              </div>
            </div>

            <div className="animate-on-scroll opacity-0 flex items-center space-x-6" style={{ animationDelay: "0.6s" }}>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="animate-on-scroll opacity-0" style={{ animationDelay: "0.8s" }}>
              <div className="relative">
                ...
                <div className="bg-gray-900 rounded-[3rem] p-8 relative overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    <div className="text-white/80 font-script text-lg">Landry</div>
                  </div>
                </div>
                ...
                <div className="flex justify-center space-x-4 mt-8">
                  ...
                  <Button variant="outline" className="border-gray-300 hover:border-gray-400 bg-transparent">
                    My Work →
                  </Button>
                </div>
              </div>
